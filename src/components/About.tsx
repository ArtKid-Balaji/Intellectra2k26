...
import { Shield, Zap, Globe, Award, X } from "lucide-react";
          ...
          {selectedImage && (
            ...
            >
              ...
              <motion.div
                ...
                className="relative max-w-4xl max-h-96 w-full mx-4"
              >
                {/* Close Button */}
                <button
                  onClick={() => setSelectedImage(null)}
                  className="absolute -top-12 -left-12 text-white hover:text-neon-cyan transition-colors z-10"
                >
                  <X size={32} />
                </button>
